...
void ABaseGun_CPP::PlayFireEffects()
{
	PlayFireSound();
...
void ABaseGun_CPP::PlayMuzzleFlash()
{
...
void ABaseGun_CPP::PlayGunFireAnimation()
{
	if (WeaponMeshSkeletal->IsActive())
	{
...
void ABaseGun_CPP::PlayFireSound()
{
	if (FireSound)
	{
		// Play 2D sound 
...
bool ABaseGun_CPP::BeginReloadAnimation()
{
...
void ABaseGun_CPP::SetLocationToFireTowards(FVector NewLocation)
{
	LocationToFireTowards = NewLocation;
}

void ABaseGun_CPP::FireTowardsLocation()
{
...
void ABaseGun_CPP::FirePoolProjectile(ABaseProjectile* PoolProjectileToFire)
{
...
void ABaseGun_CPP::CreateProjectileToFire()
{
...
FTransform ABaseGun_CPP::GetFireSocketTransform()
{
...
// Called every frame
void ABaseGun_CPP::Tick(float DeltaTime)
{
...
void ABaseGun_CPP::SetProjectileType(TSubclassOf<ABaseProjectile> NewProjectileType)
{
	ProjectileType = NewProjectileType;
}

float ABaseGun_CPP::GetProjectileVelocity()
{
	return ProjectileVelocity;
}

int ABaseGun_CPP::GetCurrentAmmo()
{
	return CurrentAmmoClip;
}

int ABaseGun_CPP::GetTotalAmmo()
{
	return CurrentAmmoTotal;
}

int ABaseGun_CPP::GetMaxClipAmmo()
{
	return MaxClipAmmo;
}

void ABaseGun_CPP::SetLineTraceTestStart(FVector LineTraceLocation, FRotator LineTraceRotation)
{
	LineTraceStartLocation = LineTraceLocation;
	LineTraceStartRotation = LineTraceRotation;
}

bool ABaseGun_CPP::GetShouldLineTraceTest()
{
